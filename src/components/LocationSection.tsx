...
const locations = [
  {
    ...
    mapSrc:
      'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d795.3207238967851!2d-79.20365271447122!3d-3.991993912290126!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91cb4935f8ac8e47%3A0x4755ec98a0ee4d3c!2sInduscrubs%20(indumentaria%20m%C3%A9dica%20)!5e1!3m2!1sen!2sec!4v1788184024147!5m2!1sen!2sec',
    mapTitle: 'Ubicación INDUSCRUBS Loja, Ecuador',
    address: 'Antonio José de Sucre y Juan de Salinas',
    phone: '0988223950',
    whatsapp: 'https://wa.me/593988223950',
  },
  {
    title: 'Induscrubs - Sucursal Annexa',
    mapSrc:
      'https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3980.097415313176!2d-79.20385739999999!3d-4.0003928!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91cb376bad51dc8f%3A0xef00cb503802e861!2sInduscrubs%20-%20Sucursal%20Annexa!5e0!3m2!1ses-419!2sec!4v1790130206757!5m2!1ses-419!2sec',
    mapTitle: 'Ubicación Sucursal INDUSCRUBS Loja, Ecuador',
    address: '18 de Noviembre y Azuay',
    phone: '0988223950',
    whatsapp: 'https://wa.me/593988223950',
  },
];
    ...
    <section id="ubicacion" className="relative w-full bg-[#FFFFFF] scroll-mt-24">
      <div className="w-full flex flex-col md:flex-row">
        {locations.map((location) => (
          <div key={location.title} className="relative w-full md:w-1/2 flex flex-col md:block">
            {/* Embedded Google Map */}
            ...
            <div className="w-full md:w-auto md:absolute md:bottom-8 md:right-8 lg:bottom-12 lg:right-12 z-10 px-4 py-4 md:p-0">
              <div className="w-full md:w-[350px] lg:w-[370px] bg-[#FFFFFF] rounded-[6px] shadow-lg border border-[#DDE3EA] p-6 sm:p-7">
                ...
                <div className="mb-4 text-sm text-[#16232F] flex items-start gap-2.5">
                  ...
                  <span className="text-[#5B6B7A]">{location.address}</span>
                </div>
                ...
                <div className="mb-5 text-sm flex items-center gap-2.5">
                  ...
                  <a
                    ...
                    aria-label={`Contactar por WhatsApp al ${location.phone}`}
                  >
