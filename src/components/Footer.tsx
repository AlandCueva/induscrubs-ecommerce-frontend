  ...
  return (
    <footer className="w-full bg-[#84B8FF] text-[#FFFFFF] border-t border-[#DDE3EA] pt-12 pb-8">
      <div className="max-container">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 lg:gap-14 pb-12 border-b border-[#DDE3EA]">
          {/* COLUMN 1: Brand + Colecciones (stacks first on mobile) */}
          ...
          {/* COLUMN 2: Store Locations & Hours (stacks second on mobile) */}
          <div className="space-y-3">
            <h4 className="type-micro text-[#FFFFFF] font-bold tracking-widest uppercase">
          ...
          {/* COLUMN 3: Induscrubs VIP Signup (stacks third on mobile) */}
          <div>
